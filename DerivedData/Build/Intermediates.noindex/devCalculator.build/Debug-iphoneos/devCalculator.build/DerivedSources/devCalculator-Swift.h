...
#ifndef DEVCALCULATOR_SWIFT_H
#define DEVCALCULATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="devCalculator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13devCalculator11AppDelegate")
...
SWIFT_CLASS("_TtC13devCalculator13SceneDelegate")
...
SWIFT_CLASS("_TtC13devCalculator14ViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified text3;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified text4;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified text5;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified incomelable;
- (void)viewDidLoad;
- (IBAction)calBtn:(id _Nonnull)sender;
